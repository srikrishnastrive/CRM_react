    ...
    return (
        ...
        <div className="modal-box">
            ...
            <textarea
                ...
                cols="50"
                rows="7"
                value={ticket.description} // ✅ Moved inside the tag
                readOnly // (Optional) Prevents editing if it's just for display
            />

            <h1 className=" text-lg text-white">
                Priority :
                <select className="mx-2 p-1 bg-white text-black">
            ...
            <h1 className="text-lg text-white my-4">
                    Status: 
                    <select name="status" className="p-1 mx-2 bg-white text-black" >
            ...
            <div className="modal-action">
                <button className="btn-success px-4 py-2 rounded-md hover:bg-green-400 transition-all ease-in-out">Update ticket</button>
            </div>
        </div>
